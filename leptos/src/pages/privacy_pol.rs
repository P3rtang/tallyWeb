...
pub fn PrivacyPolicy(cx: Scope) -> impl IntoView {
    view! {cx,
        <div class="page">
            ...
            <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to tallyWeb.</p>
            </li>
            <li>
            ...
            either generated by the use of the Service or from the Service
                ...
                <li>
                <p><strong>Website</strong> refers to tallyWeb, accessible from <a href="https://www.termsfeed.com/live/leptos.p3rtang.me" rel="external nofollow noopener" target="_blank">leptos.p3rtang.me</a></p>
                </li>
                <li>
                ...
                <p>Usage Data may include information such as Your Devices Internet
            ...
            while Session Cookies are deleted as soon as You close Your web browser.
                You can learn more about cookies on <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" target="_blank">TermsFeed website</a> article.</p>
