...
pub fn PrivacyPolicy() -> impl IntoView {
    view! {
        <div class="page">
            <div class="header">
                <div class="container">
                    <p class="title">Privacy Policy for tallyWeb</p>
                </div>
            </div>
                        ...
                        <ul>
                            ...
                            <li>
                                <p>
                                    ...
                                    (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to tallyWeb.
                                </p>
                            </li>
                            <li>
                                <p>
                            ...
                            <li>
                                <p>
                                    ...
                                    refers to tallyWeb, accessible from
                                    <a
                                        href="https://www.termsfeed.com/live/leptos.p3rtang.me"
